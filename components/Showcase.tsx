...
export const Showcase: React.FC = () => {
  return (
    <section className="px-6 py-24 bg-neutral-50 overflow-hidden">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16 md:gap-24">
            ...
            <div className="relative z-10 bg-neutral-900 rounded-[3rem] p-3 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] border-[8px] border-neutral-800">
              <div className="bg-white rounded-[2.2rem] overflow-hidden aspect-[9/19.5] relative">
                ...
                <div className="mt-14 px-6 space-y-4">
                  <div>
                    <h4 className="font-black text-2xl text-neutral-900">Ma Boutique Chic</h4>
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 bg-neutral-900 rounded-2xl flex justify-between items-center shadow-2xl">
                   ...
                   <div className="px-4 py-2 bg-emerald-500 rounded-xl text-[10px] font-black text-white">COMMANDER</div>
                </div>
              </div>
            </div>
        ...
        <div className="flex-1 order-1 md:order-2 space-y-8">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-neutral-900 leading-[1.1] tracking-tight">
          ...
          <div className="grid grid-cols-2 gap-6 pt-4">
            <div className="p-6 rounded-3xl bg-white border border-neutral-100 shadow-sm">
              <div className="text-emerald-500 font-black text-3xl mb-1 tracking-tighter">100%</div>
              <p className="text-[11px] font-bold uppercase text-neutral-400 tracking-wider">Sur-mesure</p>
            </div>
            <div className="p-6 rounded-3xl bg-white border border-neutral-100 shadow-sm">
              <div className="text-emerald-500 font-black text-3xl mb-1 tracking-tighter">2 min</div>
              <p className="text-[11px] font-bold uppercase text-neutral-400 tracking-wider">Installation</p>
            </div>
          </div>
        </div>
      </div>
