...
export const FinalCTA: React.FC = () => {
  return (
    <section className="px-6 py-28 bg-[#1A1A1A] text-white text-center relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto space-y-10 relative z-10">
        ...
        <div className="pt-6 flex flex-col items-center gap-6 w-full">
          <button className="w-full bg-white text-[#1A1A1A] font-black py-6 rounded-[1.5rem] shadow-[0_25px_60px_-15px_rgba(255,255,255,0.1)] hover:bg-neutral-100 hover:scale-[1.02] active:scale-95 transition-all text-xl whitespace-nowrap uppercase tracking-tight">
